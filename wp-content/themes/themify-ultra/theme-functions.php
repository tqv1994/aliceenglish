...
function themify_theme_header_background( $area = 'header', $classes = '' ) {
	...
	if ( 'header' === $area && ($area_wrap==='video' || $area_wrap==='slider')) {
		...
		if ( is_singular( array( 'post', 'portfolio', 'page', 'product' ) ) || themify_is_shop() ) {
			global $themify;
...
/**
 * Script to load IE11-specific stylesheet
 *
 * @hooked to "themify_body_end"
 */
function themify_theme_fullpage_ie11_patch() {
	if ( ! themify_theme_is_fullpage_scroll() ) {
		return;
	}
	...
	if ( /MSIE|Trident/.test( window.navigator.userAgent ) ) {
		...
		style.setAttribute( 'href', '<?php echo THEME_URI . "/styles/compatibility/ie11.css"; ?>' );
		document.body.appendChild( style );
	}
	</script>
<?php }
add_action( 'themify_body_end', 'themify_theme_fullpage_ie11_patch' );