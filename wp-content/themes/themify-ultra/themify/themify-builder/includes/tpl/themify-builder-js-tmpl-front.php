	...
	<div id="tb_editor" class="tf_abs tf_hide tf_opacity">
		...
		<ul id="tb_editor_menu">
			<li>
				...
				<button type="button" class="tb_editor_action tb_editor_unlink_icon" data-type="unlink"><?php echo themify_get_icon('unlink','ti')?><span class="themify_tooltip"><?php _e('Unlink', 'themify') ?></span></button>
				<button type="button" class="tb_editor_action" data-type="link"><?php echo themify_get_icon('link','ti')?></button>
			</li>
			<li data-type="formatBlock">
				<span class="themify_tooltip"><?php _e('Paragraph', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-action="p"><?php echo themify_get_icon('paragraph','ti')?></button>
				<ul class="tb_editor_options">
					<li><button type="button" class="tb_editor_action" data-action="p">P</button></li>
					<li><button type="button" class="tb_editor_action" data-action="h1">H1</button></li>
					<li><button type="button" class="tb_editor_action" data-action="h2">H2</button></li>
					<li><button type="button" class="tb_editor_action" data-action="h3">H3</button></li>
					<li><button type="button" class="tb_editor_action" data-action="h4">H4</button></li>
					<li><button type="button" class="tb_editor_action" data-action="h5">H5</button></li>
					<li><button type="button" class="tb_editor_action" data-action="h6">H6</button></li>
					<li><button type="button" class="tb_editor_action" data-action="pre"><?php echo themify_get_icon('fas code','fa')?></button><span class="themify_tooltip"><?php _e('Preformatted', 'themify') ?></span></button></li>
					<li><button type="button" class="tb_editor_action" data-action="blockquote"><?php echo themify_get_icon('fas quote-left','fa')?></button><span class="themify_tooltip"><?php _e('Quote', 'themify') ?></span></button></li>
				</ul>
			</li>
			<li data-type="text_align">
				<span class="themify_tooltip"><?php _e('Text Align', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-action="justifyLeft"><?php echo themify_get_icon('align-left','ti')?></button>
				<ul class="tb_editor_options">
					<li><button type="button" class="tb_editor_action" data-action="justifyLeft"><?php echo themify_get_icon('align-left','ti')?></button><span class="themify_tooltip"><?php _e('Left', 'themify') ?></span></li>
					<li><button type="button" class="tb_editor_action" data-action="justifyCenter"><?php echo themify_get_icon('align-center','ti')?></button><span class="themify_tooltip"><?php _e('Center', 'themify') ?></span></li>
					<li><button type="button" class="tb_editor_action" data-action="justifyRight"><?php echo themify_get_icon('align-right','ti')?></button><span class="themify_tooltip"><?php _e('Right', 'themify') ?></span></li>
					<li><button type="button" class="tb_editor_action" data-action="justifyFull"><?php echo themify_get_icon('align-justify','ti')?></button><span class="themify_tooltip"><?php _e('Justify', 'themify') ?></span></li>
				</ul>
			</li>
			<li>
				<span class="themify_tooltip"><?php _e('Bold', 'themify') ?></span>
				<button type="button" class="tb_editor_action tb_editor_bold" data-type="bold">B</button>
			</li>
			<li>
				<span class="themify_tooltip"><?php _e('Italic', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-type="italic"><?php echo themify_get_icon('Italic','ti')?></button>
			</li>
			<li>
				<span class="themify_tooltip"><?php _e('Text Decoration', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-type="underline"><?php echo themify_get_icon('underline','ti')?></button>
			</li>
			<li>
				<span class="themify_tooltip"><?php _e('Strikethrough', 'themify') ?></span>
				<button type="button" class="tb_editor_action tb_editor_strike" data-type="strikethrough">S</button>
			</li>
			<li data-type="list">
				<span class="themify_tooltip"><?php _e('List Settings', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-action="insertUnorderedList"><?php echo themify_get_icon('list','ti')?></button>
				<ul class="tb_editor_options">
					<li><button type="button" class="tb_editor_action" data-action="insertUnorderedList"><?php echo themify_get_icon('ti-list','ti')?></button><span class="themify_tooltip"><?php _e('Unordered List', 'themify') ?></span></li>
					<li><button type="button" class="tb_editor_action" data-action="insertOrderedList"><?php echo themify_get_icon('ti-list-ol','ti')?></button><span class="themify_tooltip"><?php _e('Ordered List', 'themify') ?></span></li>
					<li><button type="button" class="tb_editor_action" data-type="Indent"><?php echo themify_get_icon('control-skip-forward','ti')?></button><span class="themify_tooltip"><?php _e('Increase Indent', 'themify') ?></span></li>
					<li><button type="button" class="tb_editor_action" data-type="Outdent"><?php echo themify_get_icon('control-skip-backward','ti')?></button><span class="themify_tooltip"><?php _e('Decrease Indent', 'themify') ?></span></li>
				</ul>
			</li>	
			<?php 
			/*				
			...
			*/			
			...
			<li>
				...
				<button type="button" class="tb_editor_action" data-type="color"><?php echo themify_get_icon('paint-bucket','ti')?></button>
			</li>
			<li>
				<span class="themify_tooltip"><?php _e('Fonts', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-type="font"><?php echo themify_get_icon('text','ti')?></button>
			</li>
			<li>
				<span class="themify_tooltip"><?php _e('Expand', 'themify') ?></span>
				<button type="button" class="tb_editor_action" data-type="expand"><?php echo themify_get_icon('new-window','ti')?></button>
			</li>
		</ul>
	</div>
</template>