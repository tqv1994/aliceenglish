	...
	protected function _visual_template() {
	    ...
	    <# }
			...
			const icon=data.link_options == 'newtab'?'fa-external-link':'fa-search',
				...
				image ='<img style="display:none" src="'+ data.image_service_menu +'" class="tb_menu_image" data-w="height_service_menu" data-h="height_service_menu" alt="'+alt+'">';
				tb_app.Utils.resizeImage('.tb_element_cid_'+data.cid+' .tb_menu_image',data.width_service_menu,data.height_service_menu);
