	    ...
	    <div class="module-icon-item<?php echo 'icon_horizontal'===$fields_args['icon_arrangement']?' tf_inline_b':''; ?>">
			...
			<?php endif; ?>
				...
				<?php elseif('hide'===$content['hide_label']): ?>
					<span class="screen-reader-text"<?php self::add_inline_edit_fields('label',true,false,'content_icon')?>><?php echo $content['label']===''?__('Label','themify'):$content['label']; ?></span>
				<?php endif; ?>
			<?php if ($content['link']!==''): ?>
				</a>
			<?php endif; ?>
