...
this.params.onInit.call(this);k.triggerEvent(this.el,"tf_carousel_init",this);k.trigger("tf_swiper_init",this);jQuery.fn.fullpage&&jQuery.fn.fullpage.reBuild()},E=function(a,c){for(let g=a.length-1;-1<g;--g)if(a[g].classList.contains("tf_swiper-process")||a[g].classList.contains("tf_swiper-container-initialized")){let c=a[g].swiper;c&&c.params.autoHeight&&c.updateAutoHeight(c.params.speed,!1)}else a[g].classList.add("tf_swiper-process"),k.isRTL&&a[g].setAttribute("dir","rtl"),themify_vars.lz&&k.lazyScroll(a[g].querySelectorAll("[data-lazy]"),
!0),k.imagesLoad(a[g],function(m){let t=!1,b=m.elements[0],p=b.getElementsByClassName("tf_swiper-slide").length,l=[],n=function(){if(!b.classList.contains("tf_swiper-container-initialized")){for(var a=l.length-1;-1<a;--a)if(!0!==h[l[a]])return!1;var c=d.controllers?r.createElement("a"):!1;if(!1!==d.slider_nav||!1!==d.pager||!1!==c){a=r.createElement("div");a.className="tf_carousel_nav_wrap carousel-nav-wrap";if(!1!==d.slider_nav){var f=r.createElement("a");const b=r.createElement("a");f.className=
"tf_box tf_overflow carousel-prev";b.className="tf_box tf_overflow carousel-next";f.href="#";b.href="#";a.appendChild(f);a.appendChild(b);e.navigation={disabledClass:"disabled",nextEl:b,prevEl:f}}if(!1!==d.pager&&(f=r.createElement("div"),f.className="tf_clear tf_textc carousel-pager",a.appendChild(f),e.pagination={el:f,type:d.page_type&&"image_pagination"!==d.page_type?d.page_type:"bullets",bulletElement:"a",modifierClass:"tf_carousel_",bulletClass:"tf_carousel_bullet",currentClass:"selected",bulletActiveClass:"selected",
clickable:!0},"image_pagination"===d.page_type||"1"===b.getAttribute("data-page-num"))){const a="image_pagination"===d.page_type?b.querySelectorAll("[data-swiper-thumb]"):null;e.pagination.renderBullet=function(b,c){let d="";null!==a?a[b]&&(d='<img importance="low" decoding="async" src="'+a[b].getAttribute("data-swiper-thumb")+'">'):d=b+1;return'<a class="'+c+'">'+d+"</a>"}}!1!==c&&(c.className="tf_slider_controller tf_box tf_rel",c.href="#",c.addEventListener("click",function(a){a.preventDefault();
a.stopPropagation();a=b.swiper.parent?b.swiper.parent:b;const c=a.swiper.autoplay,d=a.swiper.thumbs&&a.swiper.thumbs.swiper?a.swiper.thumbs.swiper:null;this.classList.contains("paused")?(this.classList.remove("paused"),a.dataset.stopped=!1,c.start(),d&&(d.$el[0].dataset.stopped=!1,d.autoplay.start())):(this.classList.add("paused"),a.dataset.stopped=!0,c.stop(),d&&(d.$el[0].dataset.stopped=!0,d.autoplay.stop()))}),a.appendChild(c));d.nav_out?(c=b.nextElementSibling,null!==c&&c.classList.contains("tf_lazy")?
c.after(a):b.after(a)):b.parentNode.appendChild(a)}if(t){const a="string"===typeof t?"next"===t?b.nextElementSibling:r.getElementsByClassName(t)[0]:t;if(a)if(a.swiper)e.thumbs={swiper:a.swiper,multipleActiveThumbs:!1},a.swiper.parent=b;else return a.addEventListener("tf_carousel_init",function(d){b.classList.contains("tf_swiper-container-initialized")||(e.thumbs={swiper:this.swiper,multipleActiveThumbs:!1},a.swiper.parent=b,b.firstElementChild.classList.remove("tf_lazy"),new TF_Swiper(b,e),b.classList.remove("tf_swiper-process"))},
{once:!0,passive:!0}),a.hasAttribute("data-lazy")&&k.lazyScroll([a],!0),!1}b.firstElementChild.classList.remove("tf_lazy");new TF_Swiper(b,e);b.classList.remove("tf_swiper-process")}};m=function(a){if(a){const b=a.split(",");for(let a=b.length-1;-1<a;--a)h[b[a]+"-css"]||(l.push(b[a]+"-css"),k.LoadCss(b[a],b[a].indexOf("v=")?!1:null,null,null,function(){h[b[a]+"-css"]=!0;1<p&&n()}))}};var f=b.getAttribute("data-speed");"slow"===f?f=4:"fast"===f?f=.5:"normal"===f&&(f=1);const d=c?c:{wrapvar:b.hasAttribute("data-wrapvar")?
...
!0);m=b.querySelectorAll(".tf_lazy,.tf_svg_lazy");if(f=b.querySelector(".video-wrap[data-url]"))f.appendChild(A(f.getAttribute("data-url"))),f.removeAttribute("data-url");for(f=m.length-1;-1<f;--f)m[f].classList.remove("tf_lazy","tf_svg_lazy");b.classList.add("tf_swiper-container-initialized");c&&c.onInit&&c.onInit.call()}else{if(themify_vars.lz||!1!==d.lazy){f=b.querySelectorAll(".tf_lazy:not(.tf_swiper-wrapper)");for(var q=f.length-1;-1<q;--q)f[q].classList.remove("tf_lazy");e.preloadImages=!1;
e.on.transitionStart=C}else e.lazy=!1,k.lazyScroll(b.querySelectorAll("[data-lazy]"),!0);d.onInit&&(e.onInit=d.onInit);e.on.transitionEnd=B;f=d.effect?d.effect:"";f=!f||"crossfade"!==f&&"cover-fade"!==f&&"uncover-fade"!==f?f:"fade";!f||"scroll"===f||"fade"!==f&&"flip"!==f&&"cube"!==f&&"coverflow"!==f?e.effect="":(e.effect=f,"fade"===f||"flip"===f||"cube"===f?(e.slidesPerView=e.slidesPerGroup=1,d.mob_visible=d.tab_visible=0):"coverflow"===f&&2>e.slidesPerView&&(e.slidesPerView=2),"fade"!==f&&(e[f+
...
r.createElement("div"),d=e.autoplay.delay;a.className="tf_sw_timer tf_abs";b.appendChild(a);e.on.slideChangeTransitionStart=function(b){let c=0;const e=function(){100>c&&(requestAnimationFrame(e),a.style.width=c+"%",++c)};setTimeout(function(){},d);e()}}h.autoplay||l.push("autoplay")}!0!==e.mousewheel||h.mousewheel||l.push("mousewheel");!0!==e.keyboard||h.keyboard||l.push("keyboard");!0!==e.parallax||h.parallax||l.push("parallax");d.thumbs&&("string"!==typeof d.thumbs||"next"===d.thumbs&&null!==b.nextElementSibling&&
b.nextElementSibling.classList.contains("tf_swiper-container")||"next"!==d.thumbs&&r.getElementsByClassName(d.thumbs)[0]?(h.thumbs||l.push("thumbs"),t=d.thumbs):delete d.thumbs);d.scrollbar&&(h.scrollbar||l.push("scrollbar"),e.scrollbar={draggable:!0,hide:!0,el:d.scrollbar});"vertical"!==e.direction||h["vertical-css"]||l.push("vertical-css");"scroll"===e.effect||""===e.effect||h[e.effect+"-css"]||l.push(e.effect+"-css");m(d.css_url);"vertical"!==e.direction||h["vertical-css"]||k.LoadCss(y+"vertical.css",
null,null,null,function(){h["vertical-css"]=!0;n()});""===e.effect||"scroll"===e.effect||"coverflow"===e.effect||h[e.effect+"-css"]?"coverflow"===e.effect&&(h[e.effect+"-css"]=!0,n()):k.LoadCss(y+"effects/"+e.effect+".css",null,null,null,function(){h[e.effect+"-css"]=!0;n()});if(0<l.length){m=!1;for(let a=l.length-1;-1<a;--a)h[l[a]]||-1!==l[a].indexOf("-css")||(m=!0,k.LoadAsync((l[a]===e.effect?z+"effects/":z+"modules/")+l[a]+".min.js",function(){h[l[a]]=!0;n()},x,null,function(){return!!h[l[a]]}));
!1===m&&n()}else n()}})},u=function(a,c){!0===h.swiper&&!0===h.swiper_css&&!0===h.imagesLoad&&E(a,c)};k.on("tf_carousel_init",function(a,c){a instanceof jQuery?a=a.get():void 0===a.length&&(a=[a]);"object"!==typeof c&&(c=!1);h.swiper_css||k.LoadCss(k.css_modules.sw,null,null,null,function(){h.swiper_css=!0;u(a,c)});h.imagesLoad||k.imagesLoad(function(){h.imagesLoad=!0;u(a,c)});h.swiper||k.LoadAsync(k.js_modules.sw,function(){h.swiper=!0;u(a,c)},x,null,function(){return"undefined"!==typeof TF_Swiper&&
"undefined"!==typeof TF_Swiper.Utils});u(a,c)})})(Themify,document);
