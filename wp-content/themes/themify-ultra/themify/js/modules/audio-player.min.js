...
function(a){a.preventDefault();p.triggerEvent(m,h)});n.addEventListener(h,function(b){"click"===b.type&&(b.preventDefault(),b.stopPropagation());a.muted=!a.muted},{passive:"click"!==h});p.isTouch||e.addEventListener("mouseenter",function(){if(!isNaN(a.duration)){r.classList.remove("tf_hide");const b=this.clientWidth,c=parseFloat(r.clientWidth/2),f=a.duration,d=function(a){const d=void 0!==a.layerX?a.layerX:a.offsetX;0<d-c&&a.layerX<=b&&(r.style.transform="translateX("+(d-c)+"px)",r.textContent=u(parseFloat(d/
b)*f))};this.addEventListener("mouseleave",function(){r.classList.add("tf_hide");this.removeEventListener("mousemove",d,{passive:!0})},{passive:!0,once:!0});this.addEventListener("mousemove",d,{passive:!0})}},{passive:!0});b.addEventListener("input",function(b){b.preventDefault();b.stopPropagation();isNaN(a.duration)||(a.paused||!0!==z||a.pause(),C=!0,b=parseInt(this.value),a.currentTime=100===b?a.duration-1:parseFloat(b*a.duration/100).toFixed(4))});b.addEventListener("change",function(b){b.preventDefault();
b.stopPropagation();isNaN(a.duration)||(C=z=!1,a.paused&&a.play().then(a=>{z=!0}).catch(a=>{z=!0}))});a.addEventListener("progress",function(){0<this.buffered.length&&(k.style.transform="scaleX("+parseFloat(this.buffered.end(0)/this.duration).toFixed(4)+")")},{passive:!0});a.addEventListener("durationchange",function(){y.textContent=u(this.duration)},{passive:!0});a.addEventListener("waiting",function(){e.classList.add("tf_audio_waiting");this.addEventListener("playing",function(){e.classList.remove("tf_audio_waiting")},
{passive:!0,once:!0})},{passive:!0});a.addEventListener("emptied",function(){e.classList.add("tf_audio_waiting");this.addEventListener("playing",function(){e.classList.remove("tf_audio_waiting")},{passive:!0,once:!0})},{passive:!0});a.addEventListener("pause",function(){m.classList.remove("tf_audio_playing")},{passive:!0});a.addEventListener("play",function(){m.classList.add("tf_audio_playing");const a=g.getElementsByTagName("audio");for(let b=a.length-1;-1<b;--b)a[b]!==this&&a[b].pause()},{passive:!0});
a.addEventListener("timeupdate",function(){if(!isNaN(this.duration)){w.textContent=u(this.currentTime);let a=parseFloat(this.currentTime/this.duration);t.style.transform="scaleX("+a.toFixed(4)+")";!1===C&&(b.value=parseInt(100*a))}},{passive:!0});a.addEventListener("volumechange",function(){0!==this.volume&&n.classList.remove("tf_mute_disabled");!0===this.muted||0===this.volume?(0===this.volume&&n.classList.add("tf_mute_disabled"),n.classList.add("tf_muted")):n.classList.remove("tf_muted")},{passive:!0});
e.appendChild(k);e.appendChild(t);e.appendChild(b);e.appendChild(r);v.appendChild(n);!1===D&&(d.addEventListener("input",function(b){b.preventDefault();b.stopPropagation();a.volume=parseFloat(this.value/100).toFixed(3)}),B.appendChild(d),v.appendChild(B));q.appendChild(l);q.appendChild(w);q.appendChild(e);q.appendChild(y);q.appendChild(v);c.appendChild(q);if(A){const b=c.appendChild(E(f,a)),d=g.createElement("button"),e=g.createElement("button");d.className="tf_playlist_prev tf_play_disabled";e.className=
"tf_playlist_next";1>=b.children.length&&(e.className+=" tf_play_disabled");d.tabIndex=e.tabIndex=0;d.type=e.type="button";l.addEventListener(h,function(a){const c=a.target.classList;!c.contains("tf_play_disabled")&&(c.contains("tf_playlist_prev")||c.contains("tf_playlist_next"))&&("click"===a.type&&(a.preventDefault(),a.stopPropagation()),a=b.getElementsByClassName("tf_audio_current")[0])&&(a=c.contains("tf_playlist_prev")?a.previousElementSibling:a.nextElementSibling)&&(p.triggerEvent(a.getElementsByClassName("tf_playlist_caption")[0],
h),c.contains("tf_playlist_prev")?(e.classList.remove("tf_play_disabled"),c.toggle("tf_play_disabled",!a.previousElementSibling)):(d.classList.remove("tf_play_disabled"),c.toggle("tf_play_disabled",!a.nextElementSibling)))},{passive:"click"!==h});a.addEventListener("ended",function(){if(!e.classList.contains("tf_play_disabled"))p.triggerEvent(e,h);else if(a.hasAttribute("data-loop")||a.hasAttribute("loop")){const a=b.getElementsByClassName("tf_playlist_caption")[0];a&&(d.classList.add("tf_play_disabled"),
e.classList.toggle("tf_play_disabled",1>=b.children.length),p.triggerEvent(a,h))}},{passive:!0});l.appendChild(d);l.appendChild(m);l.appendChild(e)}else l.appendChild(m);a.parentNode.classList.remove("tf_lazy");a.parentNode.insertBefore(c,a)},F=function(a,f){for(let g=a.length-1;-1<g;--g){let e=a[g];if(null===e.previousElementSibling||!e.previousElementSibling.classList.contains("tf_audio_container")){if(!f){var c=e.parentNode.parentNode;if(c.classList.contains("wp-audio-playlist")){let a=c.getElementsByClassName("tf-playlist-script")[0];
a||(a=c.getElementsByClassName("wp-playlist-script")[0]);a&&(f=JSON.parse(a.textContent),"audio"!==f.type&&(f=!1))}}if(!e.hasAttribute("src")&&!e.getElementsByTagName("source")[0]){if(!f||!f.tracks)continue;c=f.tracks[0].src;if(!c)for(let a=1,e=f.tracks.length;a<e;++a)if(f.tracks[a].src){c=f.tracks[a].src;break}if(!c)continue;e.setAttribute("src",c)}4===e.readyState?A(e,f):p.requestIdleCallback(function(){e.addEventListener("loadedmetadata",function(){A(this,f)},{passive:!0,once:!0});e.setAttribute("preload",
"metadata");!0===D&&e.load()},200)}}};p.on("tf_audio_init",function(a,f){a instanceof jQuery?a=a.get():void 0===a.length&&(a=[a]);F(a,f)})})(Themify,document);
