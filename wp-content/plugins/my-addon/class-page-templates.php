 ...
 * @since 2.0.0
 */
class PageTemplates extends BaseModule {
     ...
     */
    const TEMPLATE_WIDGET_BXH = 'widget_bxh';
    ...
    public function add_page_templates( $page_templates, $wp_theme, $post ) {
        ...
        $page_templates = [
                self::TEMPLATE_WIDGET_BXH => _x( 'Widget BXH', 'Page Template', 'elementor' ),
            ] + $page_templates;
    ...
    public function get_template_path( $page_template ) {
        ...
        switch ( $page_template ) {
            case self::TEMPLATE_WIDGET_BXH:
                $template_path = __DIR__ . '/templates/widget_bxh.php';
                break;
        }
    ...
    public function add_template_controls( Document $document, $control_id, $control_options ) {
        ...
        $document->add_control(
            ...
            [
                ...
                'condition' => [
                    $control_id => self::TEMPLATE_WIDGET_BXH,
                ],
            ]
        );
