		...
		<table class="table table-bordered player-list player-list--<?php echo esc_attr( $data->type ); ?> context--<?php echo esc_attr( $data->context ); ?>">
			...
			<tr class="anwp-bg-light">
				<th class="anwp-text-center">
					<span class="d-none d-sm-inline-block"><?php echo esc_html( AnWPFL_Text::get_value( 'players__shortcode__rank', __( 'Rank', 'anwp-football-leagues' ) ) ); ?></span><span class="d-sm-none">#</span>
				</th>
			...
			foreach ( $players as $index => $p ) :
				...
				<tr class="anwp-text-center">
					<td class="player-list__rank align-middle text-nowrap">
						<?php
					...
					<?php if ( $data->games_played ) : ?>
						<td class="player-list__gp align-middle text-nowrap">
							<?php echo absint( $p->played ); ?>
						</td>
					<?php endif; ?>

					<td class="player-list__stat align-middle text-nowrap">
						<?php
