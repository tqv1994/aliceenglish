				...
				<tr>
					<td class="text-nowrap">
						...
						if ( 'new' === $manual_stat->competition_type ) {
							...
							echo esc_html( anwp_football_leagues()->competition->get_competition_data( $manual_stat->competition_id )->title );
						}
						?>
					</td>
					<td class="anwp-text-center"><?php echo (int) ( $manual_stat->started + $manual_stat->sub_in ); ?></td>
					<td class="anwp-text-center"><?php echo (int) $manual_stat->started; ?></td>
					<td class="anwp-text-center"><?php echo (int) $manual_stat->sub_in; ?></td>
					<td class="anwp-text-center"><?php echo (int) $manual_stat->minutes; ?>′</td>
					<td class="anwp-text-center"><?php echo (int) $manual_stat->card_y; ?></td>
					<td class="anwp-text-center"><?php echo (int) $manual_stat->card_yr; ?></td>
					<td class="anwp-text-center"><?php echo (int) $manual_stat->card_r; ?></td>
					<?php if ( 'g' === $data->position_code ) : ?>
						<td class="anwp-text-center"><?php echo (int) $manual_stat->goals_conceded; ?></td>
						<td class="anwp-text-center"><?php echo (int) $manual_stat->clean_sheets; ?></td>
					<?php else : ?>
						<td class="anwp-text-center"><?php echo (int) $manual_stat->goals; ?> (<?php echo (int) $manual_stat->goals_penalty; ?>)</td>
						<td class="anwp-text-center"><?php echo (int) $manual_stat->assists; ?></td>
						<td class="anwp-text-center"><?php echo (int) $manual_stat->own_goals; ?></td>
					<?php endif; ?>
				</tr>
			<?php endforeach; ?>
			</tbody>
