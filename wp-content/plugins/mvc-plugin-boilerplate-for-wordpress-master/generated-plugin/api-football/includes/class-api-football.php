<?php
use API_Football\Includes\i18n;
use API_Football\Includes\Dependency_Loader;
use API_Football\Core\Registry\Controller as Controller_Registry;
use API_Football\Core\Registry\Controller as Model_Registry;
use API_Football\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'API_Football' ) ) {
	 ...
	 */
	class API_Football extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      API_Football    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( API_Football::PLUGIN_ID );
