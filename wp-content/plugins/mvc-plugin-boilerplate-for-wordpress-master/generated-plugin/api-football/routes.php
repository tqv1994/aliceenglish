...
use API_Football\Core\Route_Type as Route_Type;
...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'API_Football\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'API_Football\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'API_Football\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'API_Football\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'API_Football\App\Models\Admin\Admin_Settings' )
|		->with_view( 'API_Football\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('API_Football_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type( ROUTE_TYPE::ADMIN )
	->with_controller( 'Admin_Settings@register_hook_callbacks' ) // Resolved by Router to 'API_Football\App\Controllers\Admin\Admin_Settings'.
	->with_model( 'Admin_Settings' ) // Resolved by Router to 'API_Football\App\Models\Admin\Admin_Settings'.
	->with_view( 'Admin_Settings' ); // Resolved by Router to 'API_Football\App\Views\Admin\Admin_Settings'.
