...
### __construct
    ...
    mixed API_Football\Core\Router::__construct()
...
### register_hook_callbacks
    ...
    mixed API_Football\Core\Router::register_hook_callbacks()
...
### register_generic_model_only_routes
    ...
    void API_Football\Core\Router::register_generic_model_only_routes()
...
### register_late_frontend_model_only_routes
    ...
    void API_Football\Core\Router::register_late_frontend_model_only_routes()
...
### register_generic_routes
    ...
    void API_Football\Core\Router::register_generic_routes()
...
### register_late_frontend_routes
    ...
    void API_Football\Core\Router::register_late_frontend_routes()
...
### generic_route_types
    ...
    array API_Football\Core\Router::generic_route_types()
...
### late_frontend_route_types
    ...
    array API_Football\Core\Router::late_frontend_route_types()
...
### register_route_of_type
    ...
    \API_Football\Core\Router API_Football\Core\Router::register_route_of_type(string $type)
...
### with_just_model
    ...
    mixed API_Football\Core\Router::with_just_model(mixed $model)
...
### build_controller_unique_id
    ...
    string API_Football\Core\Router::build_controller_unique_id(mixed $controller)
...
### with_controller
    ...
    object API_Football\Core\Router::with_controller(mixed $controller)
...
### with_model
    ...
    object API_Football\Core\Router::with_model(mixed $model)
...
### with_view
    ...
    object API_Football\Core\Router::with_view(mixed $view)
...
### register_routes
    ...
    void API_Football\Core\Router::register_routes(boolean $register_late_frontend_routes)
...
### dispatch
    ...
    void API_Football\Core\Router::dispatch(array $mvc_component, string $route_type)
...
### register_model_only_routes
    ...
    void API_Football\Core\Router::register_model_only_routes(boolean $register_late_frontend_routes)
...
### dispatch_only_model
    ...
    void API_Football\Core\Router::dispatch_only_model(mixed $model, string $route_type)
...
### get_fully_qualified_class_name
    ...
    string API_Football\Core\Router::get_fully_qualified_class_name(string $class, string $mvc_component_type, string $route_type)
...
### is_request
    ...
    boolean API_Football\Core\Router::is_request(string $route_type)
