...
class View {
	...
	public static function render_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {
		...
		ob_start();
		do_action( 'api_football_before_template_render', $template_name, $template_path, $located, $args );
		include( $located );
		do_action( 'api_football_after_template_render', $template_name, $template_path, $located, $args );
	...
	public static function locate_template( $template_name, $template_path = '', $default_path = '' ) {
		if ( ! $template_path ) {
			$template_path = 'api-football-templates/';
		}
		if ( ! $default_path ) {
			$default_path = API_Football::get_plugin_path() . 'app/templates/';
		}
		...
		if ( file_exists( $template ) ) {
			...
			return apply_filters( 'api_football_locate_template', $template, $template_name, $template_path );
		} else {
			return false;
		}
	}
